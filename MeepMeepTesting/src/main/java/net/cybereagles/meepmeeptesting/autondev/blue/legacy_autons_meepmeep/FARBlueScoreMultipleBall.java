...
public class FARBlueScoreMultipleBall {
...
//        Actions:
        ...
        Pose2d ball2Pos = new Pose2d(-11.5, -34, deg(270));
        Pose2d ball3Pos = new Pose2d(-11.5, -38, deg(270));
        Pose2d ball4Pos = new Pose2d(-11.5, -43, deg(270));
        Pose2d ball5Pos = new Pose2d(11.5, -34, deg(270));
        Pose2d ball6Pos = new Pose2d(11.5, -38, deg(270));
        Pose2d ball7Pos = new Pose2d(11.5, -43, deg(270));
